...
if [ "$SMOKE_TEST" = "1" ]; then
    ...
    export CHECKPOINT_BASE="${CHECKPOINT_BASE:-${PROJECT_DIR}/_debug_ckpt/llama_safe_fusion_2gpu_v2}"
    export LOG_ROOT="${LOG_ROOT:-${PROJECT_DIR}/train_logs/llama_safe_fusion_2gpu_v2_smoke_$(date +%Y%m%d_%H%M%S)}"
