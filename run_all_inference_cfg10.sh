...
# CFG-off context run: cfg_scale=1 keeps text conditioning without CFG extrapolation.
...
BASE_SAVE_ROOT="/mnt/nas125/forGPU2/lhyunki/llmseg/inference_result/FUdata/test0630_cfg1"
...
for item in "${MODELS[@]}"; do
    ...
    ARG="${DIR_NAME_MINUS_4}_${DIR_NAME_MINUS_3}_${DIR_NAME_MINUS_2}_clssloss"
...
echo "[DONE] All CFG10 inference jobs completed."
